 ...
 const message = `🔷 HeroVPN دوباره فعال شد 🔷

بعد از یک وقفه کوتاه، دوباره در کنار شما هستیم 💪
در این نسخه تلاش کرده‌ایم تمام امکانات را در همین ربات متمرکز کنیم تا تجربه‌ای ساده‌تر و راحت‌تر داشته باشید ⚙️

در صورت مشاهده هرگونه مشکل در روند استفاده، خوشحال می‌شویم از طریق پشتیبانی با ما در میان بگذارید 🙏
ادمین: @hero_support1
